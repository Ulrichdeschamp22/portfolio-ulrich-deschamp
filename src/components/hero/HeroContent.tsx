  ...
  if (variant === 'mobile') {
    return (
      ...
      >
        ...
        >
          <motion.span 
            className="inline-block px-4 py-2 rounded-lg bg-gradient-to-r from-primary/20 via-primary/30 to-accent/20 border border-primary/40 backdrop-blur-sm"
            style={{ boxShadow: '0 0 20px hsl(271 91% 65% / 0.3)' }}
